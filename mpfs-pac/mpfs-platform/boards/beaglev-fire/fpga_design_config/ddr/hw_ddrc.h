...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_RTP    0x00000006UL
    /* CFG_RTP                           [0:32]  RW value= 0x6 */
#endif
...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_WTR    0x0000000AUL
    /* CFG_WTR                           [0:32]  RW value= 0xA */
#endif
...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_REF_PER    0x00000C30UL
    /* CFG_REF_PER                       [0:32]  RW value= 0xC30 */
#endif
...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_WL    0x0000000EUL
    /* CFG_WL                            [0:32]  RW value= 0xE */
#endif
#if !defined (LIBERO_SETTING_CFG_RL)
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_RL    0x0000001CUL
    /* CFG_RL                            [0:32]  RW value= 0x1C */
#endif
