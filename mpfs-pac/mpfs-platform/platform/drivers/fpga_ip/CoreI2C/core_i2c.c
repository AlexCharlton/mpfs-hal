...
#define MAX_OFFSET_LENGTH 2u
        ...
        i2c_clock_divider_t ser_clock_speed)
    {
            ...
            (I2C_CHANNEL_0 != channel_number))
        {
            ...
            this_i2c_channel->base_address =
                ((this_i2c->base_address) & ~((addr_t)CHANNEL_MASK)) | (((addr_t)channel_number) << CHANNEL_BASE_SHIFT);
        ...
        i2c_instance_t *this_i2c)
    {
        ...
        case ST_RDATA:   /* DATA received; must clear DATA register */
            if ((this_i2c->slave_rx_buffer != (uint8_t *)0) && (this_i2c->slave_rx_idx < this_i2c->slave_rx_size))
            {
